...
if __name__ == "__main__":
    ...
    derek = cv2.imread('source_pictures/dog.jpg')
    derek = cv2.cvtColor(derek, cv2.COLOR_BGR2RGB)/255.0
    nutmeg = cv2.imread('source_pictures/cat.png')
    nutmeg = cv2.cvtColor(nutmeg, cv2.COLOR_BGR2RGB)/255.0
    print(derek.shape)
    print(nutmeg.shape)
    im1, im2 = align_images(nutmeg, derek)
    ...
    plt.imsave("dog" + '.jpg', im1)
    plt.imsave("cat" + '.jpg', im2)
